...
class Refugee(Document):
    ...
    def __init__(self,
        ...
        super().__init__(user_id=self.__generate_id(),  # registration timestamp as unique identifier
                         firstname=firstname,
                         lastname=lastname,
    ...
    def __generate_id(cls):
        ...
        The current id is generated by truncating a UUID v1 to an 8 digit integer.
        For production use, this should be replaced with a more secure method.
        """
